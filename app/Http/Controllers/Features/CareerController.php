...
class CareerController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            if (!$validate) {
                return redirect()->route('careers.create')->with('fail', 'Failed to add Announcement!');
            }
            $careers = new Career();
            ...
            if ($careers->save()) {
                return redirect()->route('careers.create')->with('success', 'Succesfully Added Career');
            } else {
                return redirect()->route('careers.create')->with('error', 'Unable Added Career');
            }
        } catch (\Throwable $e) {
            return redirect()->route('careers.create')->with('error', 'Unable Added Career: ' . $e->getMessage());
        }
    }
    ...
    public function update(Request $request, Career $career)
    {
        try {
            ...
            if ($career->save()) {
                ...
                return redirect()->route('careers.edit')->with('error', 'Failed to update Careers!');
            }
        } catch (\Throwable $e) {
            return redirect()->route('careers.edit')->with('error', 'Failed to update Careers: ' . $e->getMessage());
        }
    }
    ...
    public function destroy(Career $career)
    {
        try {
            ...
            return redirect()->route('careers.index')->with('error', 'Failed to delete the Career: ' . $e->getMessage());
        }
    }
}
