...
@section('sub-content')
    <form action="{{ route('users.update', $user) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control @error('age') is-invalid @enderror" name="age" value="{{ $user->profile->age }}" required>
        </div>
        <div class="form-group">
            ...
            <div class="form-check form-check-inline">
                <input type="radio" class="form-check-input @error('gender') is-invalid @enderror" name="gender"
                    id="gender_female" value="Female" {{ $user->profile->gender === 'Female' ? 'checked' : '' }} required>
                <label class="form-check-label" for="gender_female">Female</label>
            </div>
        </div>
        <div class="form-group">
            <label for="position">Position:</label>
            <input type="text" class="form-control @error('position') is-invalid @enderror" name="position" value="{{ $user->profile->position }}" required>
        </div>
        <div class="form-group">
            ...
            <select class="form-control @error('department') is-invalid @enderror" name="department" required>
                ...
                <option value="Filipino" {{ $user->profile->department === 'Filipino' ? 'selected' : '' }}>Filipino
                    Department</option>
                <option value="EdukPanlipunan" {{ $user->profile->department === 'EdukPanlipunan' ? 'selected' : '' }}>E.S.P & Araling
        ...
        <div class="form-group">
            ...
            <input type="tel" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ $user->profile->phone_number }}" required>
        </div>
