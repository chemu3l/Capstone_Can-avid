    ...
    <div class="menu_class">
        <div class="row">
            @foreach ($careers as $career)
                <div class="col-md-3" style="margin-left: 5%; margin-top: 30px;">
                    <div class="card-body-career" style="background-color: #1A5D1A; border-radius:5%; color: white; padding: 10px;">
                        ...
                        <p class="card-text", style="margin-top: 20px;">{{ $career->career_description }}</p>
                        <span>Requirements: {{ $career->career_requirements }}</span><br><br>
                        <center>
