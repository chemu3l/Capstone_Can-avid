...
<head>
    ...
    <title>Can-avid National High School</title>
...
<body>
    <nav class="navbar sticky-top navbar-white bg-light">
        <a class="navbar-brand" href="{{ route('HomePage') }}">
            <img src="{{ asset('images/logo.png') }}" width="100" height="100" alt="logo">
            <b id="can-avidText">CAN-AVID NATIONAL HIGH SCHOOL</b>
        </a>
