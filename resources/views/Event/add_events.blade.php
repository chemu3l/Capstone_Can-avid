...
<a href="{{ route('events.index') }}" class="btn btn-info btn-lg">Go Back</a>
    <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('events') is-invalid @enderror" name="events" id="events"
                value="{{ old('events') }}" required>
        ...
        <div class="form-group">
            ...
            <input type="date"
                class="form-control @error('events_end') is-invalid @enderror"name="events_end"
        ...
        <div class="form-group text-center"><button type="submit" class="btn btn-primary btn-block">Submit</button></div>
    </form>
@endsection
