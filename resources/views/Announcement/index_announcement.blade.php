            ...
            <tbody>
                @if (count($announcements) > 0)
                    @foreach ($announcements as $announcement)
                        <tr>
                            <td  style="border: 1px solid #7A9D54; padding: 10px; white-space: normal; width: 10px; word-wrap: break-word; overflow-wrap: break-word;">{{ $announcement->announcements }}</td>
                            <td  style="border: 1px solid #7A9D54; padding: 10px; white-space: normal; width: 10px; word-wrap: break-word; overflow-wrap: break-word;">{{ $announcement->announcements_what }}</td>
                        ...
                        @endif
                            <td  style="border: 1px solid #7A9D54; padding: 10px; white-space: normal; width: 10px; word-wrap: break-word; overflow-wrap: break-word;">{{ $announcement->announcements_uploaded }}</td>

                            <td  style="border: 1px solid #7A9D54; padding: 10px; white-space: normal; width: 10px; word-wrap: break-word; overflow-wrap: break-word;">{{ $announcement->profile->name }}</td>
                            <td>
                                <center>
